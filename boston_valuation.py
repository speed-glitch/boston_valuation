...
def get_dollar_estimate(rm,ptratio,chas=False,large_range = True):
    ...
    chas -- True if property next to the river, False otherwise
    ...
    if rm < 1 or ptratio < 0:
        ...
        return
    #convert to today's values
    dollar_est = np.e ** log_est *1000 * SCALE_FACTOR
    dollar_hi = np.e ** upper *1000 * SCALE_FACTOR
    dollar_low = np.e ** lower *1000 * SCALE_FACTOR

    #Rounded estimate to nearest thousand
    ...
    print(f'USD {rounded_low} at the lower end to {rounded_hi} at the highest.')